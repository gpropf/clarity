...
class CLNodeFactoryNP {
   public:
    ...
    ClarityNode *peer_ = nullptr;  //!< If we create a new MN or attach one, we set this. Note
                             //!< that we can create ClarityNodes with no MN. These would store
                             //!< their data entirely in their DOM elements.
    ...
    CLNodeFactoryNP(const CLNodeFactoryNP &clnf_from) {
        attachmentId_ = clnf_from.attachmentId_;
        attachmentMode_ = clnf_from.attachmentMode_;
        labelText_ = clnf_from.labelText_;
        tag_ = clnf_from.tag_;
     ...
     *
     */
    INLINE CLNodeFactoryNP(const string &tag, const string &name) : tag_(tag), name_(name) {}
     ...
     */
    template <typename T>
    INLINE CLNodeFactoryNP extractPeer(ClarityNode *&peer) const & {
        peer = peer_;
        return *this;
    }
     ...
     * @return Nc*
     */
    template <template <typename = V> class Nc>
    Nc<V> *build(Nc<V> *existingNode = nullptr) {
        Nc<V> *newNode;
        if (existingNode != nullptr) {
            newNode = existingNode;
     ...
     * @return INLINE
     */
    INLINE CLNodeFactoryNP withAttachmentId(const string &attachmentId_) const & {
        CLNodeFactoryNP cpy(*this);
        cpy.attachmentId_ = attachmentId_;
        return cpy;
    }

    INLINE CLNodeFactoryNP withAttachmentId(const string &attachmentId_) && {
        CLNodeFactoryNP cpy(std::move(*this));
        cpy.attachmentId_ = attachmentId_;
        return cpy;
    }
     ...
     * @return INLINE
     */
    INLINE CLNodeFactoryNP withAttachmentMode(ClarityNode::AttachmentMode attachmentMode) const & {
        CLNodeFactoryNP cpy(*this);
        cpy.attachmentMode_ = attachmentMode;
        return cpy;
    }

    INLINE CLNodeFactoryNP withAttachmentMode(ClarityNode::AttachmentMode attachmentMode) && {
        CLNodeFactoryNP cpy(std::move(*this));
        cpy.attachmentMode_ = attachmentMode;
        return cpy;
    }
     ...
     *
     * @param attrs
     * @return CLNodeFactoryNP
     */
    INLINE CLNodeFactoryNP withAttributes(const map<string, val> &attrs) const & {
        CLNodeFactoryNP cpy(*this);
        cpy.attrs_ = attrs;
        return cpy;
    }

    INLINE CLNodeFactoryNP withAttributes(const map<string, val> &attrs) && {
        CLNodeFactoryNP cpy(std::move(*this));
        cpy.attrs_ = attrs;
        return cpy;
    }
     ...
     * @return CLNodeFactoryNP
     */
    INLINE CLNodeFactoryNP withBoundField(const string &boundField) const & {
        assert(boundField != "");
        CLNodeFactoryNP cpy(*this);
        cpy.boundField_ = boundField;
        // cout << "withBoundField:: boundField = " << boundField << "\n";
    ...
    INLINE CLNodeFactoryNP withBoundField(const string &boundField) && {
        assert(boundField != "");
        CLNodeFactoryNP cpy(std::move(*this));
        cpy.boundField_ = boundField;
        // cout << "withBoundField:: boundField = " << boundField << "\n";
     ...
     * @return CLNodeFactoryNP
     */
    INLINE CLNodeFactoryNP withChildrenOf(ClarityNode *parent) const & {
        assert(parent != nullptr);
        CLNodeFactoryNP cpy(*this);
        cpy.parent_ = parent;
        return cpy;
    ...
    INLINE CLNodeFactoryNP withChildrenOf(ClarityNode *parent) && {
        assert(parent != nullptr);
        CLNodeFactoryNP cpy(std::move(*this));
        cpy.parent_ = parent;
        return cpy;
     ...
     * @return CLNodeFactoryNP
     */
    INLINE CLNodeFactoryNP withTag(const string &tag) const & {
        CLNodeFactoryNP cpy(*this);
        cpy.tag_ = tag;
        return cpy;
    }

    INLINE CLNodeFactoryNP withTag(const string &tag) && {
        CLNodeFactoryNP cpy(std::move(*this));
        cpy.tag_ = tag;
        return cpy;
    }
     ...
     * @return CLNodeFactoryNP
     */
    INLINE CLNodeFactoryNP withName(const string &name) const & {
        CLNodeFactoryNP cpy(*this);
        cpy.name_ = name;
        return cpy;
    }

    INLINE CLNodeFactoryNP withName(const string &name) && {
        CLNodeFactoryNP cpy(std::move(*this));
        cpy.name_ = name;
        return cpy;
    }
     ...
     * @return CLNodeFactoryNP
     */
    INLINE CLNodeFactoryNP withLabelText(const string labelText) const & {
        clog("withLabelText() method currently unimplemented and has no effect.",
             ClogType::WARNING);
        CLNodeFactoryNP cpy(*this);
        cpy.labelText_ = labelText;
    ...
    INLINE CLNodeFactoryNP withLabelText(const string labelText) && {
        clog("withLabelText() method currently unimplemented and has no effect.",
             ClogType::WARNING);
        CLNodeFactoryNP cpy(std::move(*this));
        cpy.labelText_ = labelText;
     ...
     * @return CLNodeFactoryNP
     */
    INLINE CLNodeFactoryNP withParent(ClarityNode *parent) const & {
        assert(parent != nullptr);
        CLNodeFactoryNP cpy(*this);
        cpy.parent_ = parent;
        return cpy;
    ...
    INLINE CLNodeFactoryNP withParent(ClarityNode *parent) && {
        assert(parent != nullptr);
        CLNodeFactoryNP cpy(std::move(*this));
        cpy.parent_ = parent;
        return cpy;
    ...
    INLINE CLNodeFactoryNP withCppVal(V *cppVal) const & {
        // assert(cppVal != nullptr);
        CLNodeFactoryNP cpy(*this);
        cpy.cppVal_ = cppVal;
        return cpy;
    ...
    INLINE CLNodeFactoryNP withCppVal(V *cppVal) && {
        // assert(cppVal != nullptr);
        CLNodeFactoryNP cpy(std::move(*this));
        cpy.cppVal_ = cppVal;
        return cpy;
     ...
     * @return CLNodeFactoryNP
     */
    INLINE CLNodeFactoryNP withInitVal(V &initVal) const & {
        // assert(cppVal != nullptr);
    ...
    INLINE CLNodeFactoryNP withInitVal(V &initVal) && {
        // assert(cppVal != nullptr);
        CLNodeFactoryNP cpy(std::move(*this));
        cpy.initVal_ = &initVal;
        return cpy;
     ...
     * @return CLNodeFactoryNP
     */
    INLINE CLNodeFactoryNP withPeer(ClarityNode *peer) const & {
        assert(peer != nullptr);
        CLNodeFactoryNP cpy(*this);
        cpy.peer_ = peer;
        return cpy;
    ...
    INLINE CLNodeFactoryNP withPeer(ClarityNode *peer) && {
        assert(peer != nullptr);
        CLNodeFactoryNP cpy(std::move(*this));
        cpy.peer_ = peer;
        return cpy;
     ...
     * @return CLNodeFactoryNP
     */
    INLINE CLNodeFactoryNP withLinkMultiplierConstant(N linkMultiplierConstant) const & {
        assert(linkMultiplierConstant != 0);
        CLNodeFactoryNP cpy(*this);
        cpy.linkMultiplierConstant_ = linkMultiplierConstant;
        return cpy;
    ...
    INLINE CLNodeFactoryNP withLinkMultiplierConstant(N linkMultiplierConstant) && {
        assert(linkMultiplierConstant != 0);
        CLNodeFactoryNP cpy(std::move(*this));
        cpy.linkMultiplierConstant_ = linkMultiplierConstant;
        return cpy;
     ...
     * @return CLNodeFactoryNP
     */
    INLINE CLNodeFactoryNP withLinkMultiplierVariable(N *linkMultiplierVariable) const & {
        assert(*linkMultiplierVariable != 0);
        CLNodeFactoryNP cpy(*this);
        cpy.linkMultiplierVariable_ = linkMultiplierVariable;
        return cpy;
    ...
    INLINE CLNodeFactoryNP withLinkMultiplierVariable(N *linkMultiplierVariable) && {
        assert(*linkMultiplierVariable != 0);
        CLNodeFactoryNP cpy(std::move(*this));
        cpy.linkMultiplierVariable_ = linkMultiplierVariable;
        return cpy;
     ...
     * @return CLNodeFactoryNP
     */
    INLINE CLNodeFactoryNP withTransformFns(val a2b_xfmr, val b2a_xfmr = val(NULL)) const & {
        CLNodeFactoryNP cpy(*this);
        cpy.a2b_xfmr_ = a2b_xfmr;
        cpy.b2a_xfmr_ = b2a_xfmr;
        return cpy;
    ...
    INLINE CLNodeFactoryNP withTransformFns(val a2b_xfmr, val b2a_xfmr = val(NULL)) && {
        CLNodeFactoryNP cpy(std::move(*this));
        cpy.a2b_xfmr_ = a2b_xfmr;
        cpy.b2a_xfmr_ = b2a_xfmr;
        return cpy;
     ...
     * @return CLNodeFactoryNP
     */
    INLINE CLNodeFactoryNP withExistingDOMElement() const & {
        CLNodeFactoryNP cpy(*this);
        cpy.useExistingDOMElement_ = true;
        return cpy;
    }

    INLINE CLNodeFactoryNP withExistingDOMElement() && {
        CLNodeFactoryNP cpy(std::move(*this));
        cpy.useExistingDOMElement_ = true;
        return cpy;
    }
     ...
     * @return INLINE
     */
    INLINE CLNodeFactoryNP withInnerHTML(const string &innerHTML) const & {
        CLNodeFactoryNP cpy(*this);
        cpy.innerHTML_ = innerHTML;
        return cpy;
    }

    INLINE CLNodeFactoryNP withInnerHTML(const string &innerHTML) && {
        CLNodeFactoryNP cpy(std::move(*this));
        cpy.innerHTML_ = innerHTML;
        return cpy;
    }
     ...
     * @return CLNodeFactoryNP
     */
    INLINE CLNodeFactoryNP withEventListenerGenerator(const string &eventName, val elgfn) const & {
        CLNodeFactoryNP cpy(*this);
        cpy.eventListenerGenerator_.first = eventName;
        cpy.eventListenerGenerator_.second = elgfn;
        return cpy;
    ...
    INLINE CLNodeFactoryNP withEventListenerGenerator(const string &eventName, val elgfn) && {
        CLNodeFactoryNP cpy(std::move(*this));
        cpy.eventListenerGenerator_.first = eventName;
        cpy.eventListenerGenerator_.second = elgfn;
        return cpy;
     ...
     * @return Nc*
     */
    INLINE ClarityNode *button(const string &name, const string &text, val onClickEL = val::null()) {
        ClarityNode *button = withName(name).withTag("button").build();
        button->setBoundField("textContent");
        button->setDOMVal(val(text));
     ...
     */
    template <class Nc_any>
    INLINE ClarityNode *label(Nc_any *forNode, const string &text, bool engulfForNode = false) {
     ...
     * @return Nc*
     */
    INLINE HybridNode<V> *textInput() {
        map<string, val> inputFieldAttrs = {{"type", val("text")}};
        attrs_.merge(inputFieldAttrs);

        auto *inp = withTag("input").withBoundField("value").build<HybridNode<V>>();
        // inp->refreshDOMValueFromModel();
        // inp->pushValToPeers(inp);
        inp->refresh();
        return inp;
    ...
    INLINE ClarityNode *trInput() {
        ClarityNode *tinp = withName("tinp_" + name_).textInput();
        ClarityNode *rinp = withCppVal(nullptr).withName("rinp_" + name_).rangeInput();
        tinp->addPeer(rinp, linkMultiplierConstant_);
        ClarityNode *outerDiv = withTag("div").withName("wrapper_" + name_).build();
        outerDiv->appendChild(tinp);
        outerDiv->appendChild(rinp);
        tinp->refresh();
        return outerDiv;
     ...
     * @return Nc*
     */
    INLINE ClarityNode *attributeNode(const string &attributeName) const {
