...
void make_trs(CLNodeFactory<V, N> builder) {
...
int main() {
    ...
    CLNodeFactory<double, double> builder("div", "maindiv",
                                                       CppType::NoData);

    ClarityNode *maindiv = builder.tbuild<ClarityNode>();

    CLNodeFactory<double, double> childOfMaindivBuilder =
    ...
    CLNodeFactory<int, int> childOfMaindivBuilder_int;
    CLNodeFactory<int, int>::clone(childOfMaindivBuilder,
