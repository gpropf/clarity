 ...
 * @brief "demohl" means "high-level" demo meaning that we use the more streamlined versions of the
 * API calls to create GUI elements. This is meant to simulate the kind of coding the actual users
 * would do and the goal here is to create a smooth and pleasant experience for rapid prototyping of
 * GUI designs.
 * @version 0.4
 * @date 2023-11-05
 *
...
int main() {
    ...
    auto widthInputChannel = appBldr->textFieldChannel("widthInput", "Width (int)");
    ...
    svgChannel->addConnection(testAreaOutputChannel);
