 ...
 * @brief "demoll" means "low-level" demo meaning that we use the more detailed and complex versions
 * of the API calls to create GUI elements. Things are tested here first and then moved to
 * demohl.cpp
 * @version 0.4
 * @date 2023-11-05
 *
