...
int main() {
    ...
    CLNodeFactory<ClarityNode<double>, double, double> builder("div",
                                                               "maindiv");

    ClarityNode<double> *maindiv = builder.build();
    ...
    // ClarityNode *temp_tinp =
    // childOfMaindivBuilder.withName("temp").textInput();
