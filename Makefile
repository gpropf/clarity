...
LIBCLR_IN = clarity.cpp ButtonElement.cpp WebElemNode.cpp WebAttrNode.cpp WebNode.cpp \
			ModelNode.cpp ControlNetworkNode.cpp CompoundElement.cpp LabelledInput.cpp LabelElement.cpp
LIBCLR_OBJS = clarity.o ButtonElement.o WebElemNode.o WebAttrNode.o WebNode.o \
 			ModelNode.o ControlNetworkNode.o CompoundElement.o LabelledInput.o LabelElement.o
AR 		= emar
